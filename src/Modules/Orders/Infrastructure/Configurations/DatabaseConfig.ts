...
export class DatabaseConfig extends ConfigBase  {
  ...
  public static readonly EMAIL_NAME: string = get('EMAIL_NAME').required().asString();

  public static readonly EMAIL_PASSWORD: string = get('EMAIL_PASSWORD').required().asString();
